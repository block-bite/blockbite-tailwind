  ...
  const container = {
    ...
    ".b_grid-container": {
      ...
      [`@media (min-width: 1536px)`]: {
        gridTemplateColumns: "1fr repeat(12, minmax(128px, 128px)) 1fr",
      },

      // Responsive for max-width: 1440px - results 1280px;
      [`@media (max-width: 1440px)`]: {
        gridTemplateColumns: "1fr repeat(12, minmax(90px, 90px)) 1fr",
      },

      // Responsive for max-width: 1080px : results 960px;
      [`@media (max-width: 1080px)`]: {
        gridTemplateColumns: "1fr repeat(12, minmax(80px, 80px)) 1fr",
      },

      // Responsive for max-width: 960px : results auto
      [`@media (max-width: 960px)`]: {
        gridTemplateColumns: "0px repeat(12, 1fr) 0px",
      },
    },
  };
